...
export class SortStage extends BeanStub {
    ...
    public execute(params: StageExecuteParams): void {
        ...
        const notAggregating = _.missingOrEmpty(this.columnModel.getValueColumns());
        const sortContainsGroupColumns = sortOptions.some(opt => !!opt.column.getColDef().showRowGroup);

        this.sortService.sort(sortOptions, sortActive, deltaSort, params.rowNodeTransactions, params.changedPath, notAggregating, sortContainsGroupColumns);
    }
}
